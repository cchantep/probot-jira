    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (found >= 0) {
                ...
                description = ("Milestone " + milestone.title + " doesn't match " + issue.key + " fixVersion " + details + ": " + config.fixVersionRegex).substring(0, 140);
...
module.exports = function (app) {
    ...
    app.on("*", function (context) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            p = context.payload;
            branch = (p['pull_request'] && p.pull_request &&
                p.pull_request['head']) ? p.pull_request.head.ref
                : (p['repository']) ? p.repository.default_branch : null;
            cfg = (branch)
                ? c.getConfig(context, repoInfo, branch)
                : c.getConfig(context, repoInfo, 'master');
