...
function withJiraIssue(context, pr, config, f) {
    return __awaiter(this, void 0, void 0, function () {
        var repoInfo, issueKey, credentials, issueUrl, jiraIssue;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function jiraIssueKey(context, config, pr) {
    ...
    if (!m || m.length < 2) {
        context.log("Title of pull request #" + pr.number + " doesn't match issue expression (" + config.issueKeyRegex + "): " + pr.title);
        return undefined;
    }
    else {
        return m[1];
                ...
                case 3:
                    ...
                    return [4 /*yield*/, withJiraIssue(context, pr, config, function (data) {
                            ...
                            if (config.postMergeStatus.find(function (s) { return s == jiraStatus; })) {
                                ...
                                // TODO: Check in the schedule event handler
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            issueKey = jiraIssueKey(context, config, pr);
                            // TODO: debug
                            context.log("Check pull request #" + pr.number + " against issue " + jiraIssueId, issueKey);
                            if (!issueKey) {
                                return [2 /*return*/, find(items.slice(1))];
                            }
                            // ---
                            return [2 /*return*/, util_1.fromEither(pullrequest_1.PullRequestInfo.decode(pr))];
                    }
                });
            });
        }
        var i, jiraIssueId, repoInfo, credentials, jiraIssue, issue, resp, prInfo, config, issueUrl;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 4:
                    ...
                    return [4 /*yield*/, c.getConfig(context, prInfo.base.ref)];
                case 5:
                    config = _a.sent();
