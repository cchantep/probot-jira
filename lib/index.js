    ...
    return withJiraIssue(context, repoInfo, pr, config, function (data) {
        ...
        if (config.postMergeStatus.find(function (s) { return s == jiraStatus; })) {
            ...
            return context.github.issues
                .createComment(__assign({}, repoInfo, { issue_number: pr.number, body: "@" + author + " " + msg + ". Please check it." })).then(function (_r) { return Promise.resolve(); });
        }
    });
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            either.fold(function (msg) {
                ...
                return toggleState(context, repoInfo, StatusContext, pr.head.sha, 'success', msg, Option_1.none);
    ...
    app.on('issues.demilestoned', function (context) {
        return withIssuePR(context, function (pr) {
            ...
            return c.getConfig(context, repo, pr.base.ref).then(function (config) {
                return withJiraIssue(context, repo, pr, config, function (data) {
                    var issue = data[0], url = data[1];
