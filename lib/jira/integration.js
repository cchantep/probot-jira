                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, j.unregisterHook(creds, installedHook.self)];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, util_1.fromEither(jira_1.IssueCallback.decode(req.body))];
                        case 1:
                            issueEvent = _a.sent();
...
function onInstallation(ctx) {
    ...
    var go = function (input, out) { return __awaiter(_this, void 0, void 0, function () {
        var repoInfo, tail, prefix, creds, hooks, name, appHook, jiraProject, newHook;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (input.length == 0) {
                ...
                case 2:
                    ...
                    jiraProject = process.env[prefix + "_JIRA_PROJECT_NAME"] || process.env.INPUT_JIRA_PROJECT_NAME;
                    ...
                    return [2 /*return*/, j.registerHook(creds, newHook).then(function (_r) { return go(tail, out.concat(repoInfo)); })];
            }
        });
    }); };
...
function credentials(owner, repo) {
    ...
    var domain = process.env[prefix + "_JIRA_DOMAIN"] || process.env.INPUT_JIRA_DOMAIN;
    if (!domain) {
        return Promise.reject(new Error('Missing JIRA_DOMAIN'));
    }
    var username = process.env[prefix + "_JIRA_USER"] || process.env.INPUT_JIRA_USER;
    if (!username) {
        return Promise.reject(new Error('Missing JIRA_USER'));
    }
    var apiToken = process.env[prefix + "_JIRA_API_TOKEN"] || process.env.INPUT_JIRA_API_TOKEN;
    if (!apiToken) {
