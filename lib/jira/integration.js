...
exports.credentials = exports.ensureHook = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    ghTok = process.env.PERSONAL_TOKEN_VALUE;
                    if (!ghTok) {
                        return [2 /*return*/, Promise.reject(new Error('Missing PERSONAL_TOKEN_VALUE'))];
                    }
                    ghUser = process.env.PERSONAL_TOKEN_USER;
                    if (!ghUser) {
                        return [2 /*return*/, Promise.reject(new Error('Missing PERSONAL_TOKEN_USER'))];
                    }
                    webhookUrl = ctx.githubDispatchBaseUrl + "/jira/" + repoInfo.owner + "/" + repoInfo.repo + "?user=" + ghUser + "&pass=" + ghTok;
                    newHook = {
                        name: name,
                        url: webhookUrl,
                        enabled: true,
                    ...
                    logger('Registering new JIRA hook ...', __assign(__assign({}, newHook), { url: '***' }));
